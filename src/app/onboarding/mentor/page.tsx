    ...
    return (
        <div className="max-w-2xl mx-auto px-6 py-10 bg-white rounded-lg shadow">
          ...
          <button
            ...
            disabled={
              !formData.full_name || !formData.email || !formData.phone || !formData.linked_in || !formData.title ||
              !formData.expertise.length || !formData.timezone || !formData.bio || !formData.communication_method ||
              !formData.terms_accepted || !formData.privacy_accepted || submitting
            }
